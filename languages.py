...
localizations = {
    ...
    "ru": {
        ...
        /report [текст] - Сообщить модераторам о проблеме
        ...
        /cache_media [опционально аргумент all] - кеширование медиа""",
        ...
        "bot_rules": """В данном чате запрещается:
        1) Обсуждение политики
        2) Маты, оскорбления, угрозы и т.п
        3) Спам, DDoS, фишинг, скам, реклама и т.п
        
        Администрация (далее модераторы) данной группы имеют право:
        1) Редактировать правила группы, а также настройки автоматической системы модерации (далее бот) на своё усмотрение. (При изменениях вы будете оповещены в самой группе ботом).
        2) Корректировать решения бота, а также мутить, банить и т.д на своё усмотрение.
        3) В случае форс-мажоров все выше перечисленные правила и права могут не соблюдаться модераторами, а также возможен "блэкаут" группы для устранения угроз и восстановление бота и работоспособности группы.
        
        За не соблюдение правил в конечном итоге вы можете быть заблокированы во всех группах NEO Organization, а также добавлены в соответствующую общественную базу ботов или не адекватных пользователей.
        
        В случае ошибок системы модерации пропишите команду /report. Также модераторы сами просматривают действия бота.
        В крайних случаях можете написать нам на почту operawifi.mini.net.win.2000@gmail.com""",
        "reputation_constants": "Константы репутаций",
        "points_to_mute": "Очков нарушений до мута",
        "violations_is_equal": "Нарушение равно",
        "points": "очков",
        "user_rep": "репутации от пользователей равно",
        "moder_rep": "репутации от модераторов равно",
        "report_error": "Ошибка записи обращения по /report",
        ...
        "welcome_your_is_bot": "добро пожаловать! Подтвердите, что вы не бот.",
        "send_code": "Отправите код",
        "send_emoji": "Отправьте эмодзи",
        "send_result": "Введите результат примера",
        "welcome": "добро пожаловать в чат!",
        "was_kicked": "был исключен из чата (неправильный ответ на капчу).",
        ...
        # data_base.py
        "load_replacements_error": "Ошибка загрузки замены символов",
        "data_save_in": "Данные сохранены в",
        "save_error": "Ошибка сохранения",
        "data_base_error": "Ошибка базы данных для пользователя",
        "in_command": "при команде",
        # jokes.py
    ...
    "en": {
        ...
        "bot_off": ">>> Bot is off",
        "welcome_your_is_bot": "Welcome! Please confirm you are not a bot.",
        "send_code": "Send the code",
        "send_emoji": "Send the emoji",
        "send_result": "Enter the result of the math problem",
        "welcome": "Welcome to the chat!",
        "was_kicked": "was kicked from the chat (incorrect CAPTCHA answer).",
    ...
    "ua": {
        ...
        "welcome_your_is_bot": "ласкаво просимо! Підтвердіть, що ви не бот.",
        "send_code": "Надіслати код",
        "send_emoji": "Надправте емодзі",
        "send_result": "Введіть результат прикладу",
        "welcome": "ласкаво просимо в чат!",
        "was_kicked": "було виключено з чату (неправильна відповідь на капчу).",
